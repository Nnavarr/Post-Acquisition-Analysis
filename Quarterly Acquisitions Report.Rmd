...
# test <- 
# collect(sap_uhi_group %>% 
#     filter(`PROFIT CENTER` == '7000012434' &
#              `Fiscal Year` >= 2015))
# 
# test2 <- 
#   collect(sap_uhi_group %>% 
#     filter(`PROFIT CENTER` == '7000012380' &
#              `Fiscal Year` >= 2015))
# 
# nrow(test)
# nrow(test2)
...
# Test Function ----
# test_function <-
#   modify_depth(q_acquisitions_list[17], 2, income_statment_compilation_append, accounts = sap_accounts$SAP_number) 
