...
acq_list_og <- acq_list_final

# ---------------------------------------------------- 
 acq_list_final <- readxl::read_excel("\\\\adfs01.uhi.amerco\\departments\\mia\\group\\MIA\\Noe\\Projects\\Post Acquisition\\Report\\Quarterly Acquisitions\\Acquisition List Summary.xlsx", sheet = 'Included Acquisitions')
