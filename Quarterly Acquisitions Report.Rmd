...
# Dynamic Variables ----
  date_occ <-
    as.Date('2018-06-20') # Enter Current Month Date for data compilation ----
...
# Filter NA MEntity from nested list ----
  ...
  na_mentity_list <- 
    modify_depth(q_acquisitions_list, 1, na_filter_list)
...
# Append Occ Data to list ----
  t_list <-
      modify_depth(q_acquisitions_list[5], 2, occ_compilation)

  test_length <- t_list[[1]][[5]][[3]]

  is.null(nrow(test_length))
