...
# Import Excel File ----
acq_list_final <- readxl::read_excel("\\\\adfs01.uhi.amerco\\departments\\mia\\group\\MIA\\Noe\\Projects\\Post Acquisition\\Quarterly Acquisitions\\F20 Q2\\acquisitions_list.xlsx")
...
# Occ Data 
  occ_df =
    wss_data %>%
      filter(`MEntity` %in% x[["MEntity"]] & unm_product != 'UBOX' & Date <= '2019-09-01') %>% 
      group_by(MEntity,
               Date, 
               unm_product) %>%
...
write.csv(unit_mix_final, 'Z:\\group\\MIA\\Noe\\Projects\\Post Acquisition\\Quarterly Acquisitions\\F20 Q2\\Data\\unitmix.csv')
