...
new_pc <- modify_depth(q_acquisitions_list[16], 2, nested_list_filter, z = 'Profit_Center')
new_pc <- unlist(new_pc, recursive = FALSE)


modify_depth(new_pc, 1, data_check_na)
...
# Income statement compilation ----
q_acquisitions_list <-
  modify_depth(q_acquisitions_list[15], 2, income_statment_compilation_append, accounts = sap_accounts$SAP_number) 
