...
q1_list <- quarter_list[14]

test_function <- 
  map(q1_list, income_statment_compilation, accounts = sap_accounts$SAP_number)



  first_set <- test_function[[1]]
  
  
  
  
# Check individual income statements. 
  
  test_list <-
  q_acquisitions_list[14]
  
  test_function <- 
    modify_depth(test_list, 2, income_statment_compilation_append, accounts = sap_accounts$SAP_number)
